...
const { login, register, getFavorites, getUserById, getToReadBooks, getReadingBooks, getRead, getAllUsers, getUserByName, updateAuthInformation, updateUserInformation, addFavoriteGenres, addFavoriteWriters, sendFriendRequest, accepFriendRequest, blockUser, getListBooks } = require('../controllers/authController');

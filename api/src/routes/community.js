...
const { getAllCommunities, joinCommunity, createCommunity, getCommunity, getCommunityByName, exitCommunity, addMessageToCommunity } = require('../controllers/communityController');
